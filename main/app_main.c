...
*/
#define EXAMPLE_ESP_WIFI_SSID      "cosmic"
#define EXAMPLE_ESP_WIFI_PASS      "aptx48694062"
...
void dht11_data_callback(){
    char reqp[100];
    sprintf(reqp, "{\"temperature\": \"%.1f\", \"humidity\": \"%.1f\"}", dht11_last_data.temperature, dht11_last_data.humidity);
    dht11_response(reqp, strlen(reqp));
}
